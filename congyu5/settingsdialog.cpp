    ...
    : QWidget(parent)
{
    ...
    connect(speedBox,&QComboBox::currentIndexChanged,
            this,[=](int index)
            {
                if(index==0) GameSettings::flipSpeed=280;
                if(index==1) GameSettings::flipSpeed=180;
                if(index==2) GameSettings::flipSpeed=100;
            });
